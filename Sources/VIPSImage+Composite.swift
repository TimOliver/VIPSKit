...
extension VIPSImage {
    ...
    public func composite(withOverlay overlay: VIPSImage, mode: BlendMode, x: Int, y: Int) throws -> VIPSImage {
    ...
    public func composite(withOverlay overlay: VIPSImage, mode: BlendMode) throws -> VIPSImage {
