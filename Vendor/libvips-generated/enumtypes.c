...
vips_intent_get_type(void)
{
	...
	if (g_once_init_enter(&gtype_id)) {
		static const GEnumValue values[] = {
			...
			{ VIPS_INTENT_AUTO, "VIPS_INTENT_AUTO", "auto" },
			{ 0, NULL, NULL }
		};
...
GType
vips_text_wrap_get_type(void)
{
	static gsize gtype_id = 0;

	if (g_once_init_enter(&gtype_id)) {
		static const GEnumValue values[] = {
			{ VIPS_TEXT_WRAP_WORD, "VIPS_TEXT_WRAP_WORD", "word" },
			{ VIPS_TEXT_WRAP_CHAR, "VIPS_TEXT_WRAP_CHAR", "char" },
			{ VIPS_TEXT_WRAP_WORD_CHAR, "VIPS_TEXT_WRAP_WORD_CHAR", "word-char" },
			{ VIPS_TEXT_WRAP_NONE, "VIPS_TEXT_WRAP_NONE", "none" },
			{ 0, NULL, NULL }
		};

		GType new_type =
			g_enum_register_static(g_intern_static_string("VipsTextWrap"), values);
		g_once_init_leave(&gtype_id, new_type);
	}
...
GType
vips_sdf_shape_get_type(void)
{
	static gsize gtype_id = 0;

	if (g_once_init_enter(&gtype_id)) {
		static const GEnumValue values[] = {
			{ VIPS_SDF_SHAPE_CIRCLE, "VIPS_SDF_SHAPE_CIRCLE", "circle" },
			{ VIPS_SDF_SHAPE_BOX, "VIPS_SDF_SHAPE_BOX", "box" },
			{ VIPS_SDF_SHAPE_ROUNDED_BOX, "VIPS_SDF_SHAPE_ROUNDED_BOX", "rounded-box" },
			{ VIPS_SDF_SHAPE_LINE, "VIPS_SDF_SHAPE_LINE", "line" },
			{ 0, NULL, NULL }
		};

		GType new_type =
			g_enum_register_static(g_intern_static_string("VipsSdfShape"), values);
		g_once_init_leave(&gtype_id, new_type);
	}
...
GType
vips_foreign_saveable_get_type(void)
{
	static gsize gtype_id = 0;

	if (g_once_init_enter(&gtype_id)) {
		static const GFlagsValue values[] = {
			{ VIPS_FOREIGN_SAVEABLE_ANY, "VIPS_FOREIGN_SAVEABLE_ANY", "any" },
			{ VIPS_FOREIGN_SAVEABLE_MONO, "VIPS_FOREIGN_SAVEABLE_MONO", "mono" },
			{ VIPS_FOREIGN_SAVEABLE_RGB, "VIPS_FOREIGN_SAVEABLE_RGB", "rgb" },
			{ VIPS_FOREIGN_SAVEABLE_CMYK, "VIPS_FOREIGN_SAVEABLE_CMYK", "cmyk" },
			{ VIPS_FOREIGN_SAVEABLE_ALPHA, "VIPS_FOREIGN_SAVEABLE_ALPHA", "alpha" },
			{ VIPS_FOREIGN_SAVEABLE_ALL, "VIPS_FOREIGN_SAVEABLE_ALL", "all" },
			{ 0, NULL, NULL }
		};

		GType new_type =
			g_flags_register_static(g_intern_static_string("VipsForeignSaveable"), values);
		g_once_init_leave(&gtype_id, new_type);
	}
...
GType
vips_foreign_coding_get_type(void)
{
	static gsize gtype_id = 0;

	if (g_once_init_enter(&gtype_id)) {
		static const GFlagsValue values[] = {
			{ VIPS_FOREIGN_CODING_NONE, "VIPS_FOREIGN_CODING_NONE", "none" },
			{ VIPS_FOREIGN_CODING_LABQ, "VIPS_FOREIGN_CODING_LABQ", "labq" },
			{ VIPS_FOREIGN_CODING_RAD, "VIPS_FOREIGN_CODING_RAD", "rad" },
			{ VIPS_FOREIGN_CODING_ALL, "VIPS_FOREIGN_CODING_ALL", "all" },
			{ 0, NULL, NULL }
		};

		GType new_type =
			g_flags_register_static(g_intern_static_string("VipsForeignCoding"), values);
		g_once_init_leave(&gtype_id, new_type);
	}
...
GType
vips_foreign_keep_get_type(void)
{
	static gsize gtype_id = 0;

	if (g_once_init_enter(&gtype_id)) {
		static const GFlagsValue values[] = {
			{ VIPS_FOREIGN_KEEP_NONE, "VIPS_FOREIGN_KEEP_NONE", "none" },
			{ VIPS_FOREIGN_KEEP_EXIF, "VIPS_FOREIGN_KEEP_EXIF", "exif" },
			{ VIPS_FOREIGN_KEEP_XMP, "VIPS_FOREIGN_KEEP_XMP", "xmp" },
			{ VIPS_FOREIGN_KEEP_IPTC, "VIPS_FOREIGN_KEEP_IPTC", "iptc" },
			{ VIPS_FOREIGN_KEEP_ICC, "VIPS_FOREIGN_KEEP_ICC", "icc" },
			{ VIPS_FOREIGN_KEEP_OTHER, "VIPS_FOREIGN_KEEP_OTHER", "other" },
			{ VIPS_FOREIGN_KEEP_GAINMAP, "VIPS_FOREIGN_KEEP_GAINMAP", "gainmap" },
			{ VIPS_FOREIGN_KEEP_ALL, "VIPS_FOREIGN_KEEP_ALL", "all" },
			{ 0, NULL, NULL }
		};

		GType new_type =
			g_flags_register_static(g_intern_static_string("VipsForeignKeep"), values);
		g_once_init_leave(&gtype_id, new_type);
	}
...
vips_foreign_ppm_format_get_type(void)
{
	...
	if (g_once_init_enter(&gtype_id)) {
		static const GEnumValue values[] = {
			...
			{ VIPS_FOREIGN_PPM_FORMAT_PNM, "VIPS_FOREIGN_PPM_FORMAT_PNM", "pnm" },
			{ 0, NULL, NULL }
		};
...
GType
vips_foreign_pdf_page_box_get_type(void)
{
	static gsize gtype_id = 0;

	if (g_once_init_enter(&gtype_id)) {
		static const GEnumValue values[] = {
			{ VIPS_FOREIGN_PDF_PAGE_BOX_MEDIA, "VIPS_FOREIGN_PDF_PAGE_BOX_MEDIA", "media" },
			{ VIPS_FOREIGN_PDF_PAGE_BOX_CROP, "VIPS_FOREIGN_PDF_PAGE_BOX_CROP", "crop" },
			{ VIPS_FOREIGN_PDF_PAGE_BOX_TRIM, "VIPS_FOREIGN_PDF_PAGE_BOX_TRIM", "trim" },
			{ VIPS_FOREIGN_PDF_PAGE_BOX_BLEED, "VIPS_FOREIGN_PDF_PAGE_BOX_BLEED", "bleed" },
			{ VIPS_FOREIGN_PDF_PAGE_BOX_ART, "VIPS_FOREIGN_PDF_PAGE_BOX_ART", "art" },
			{ 0, NULL, NULL }
		};

		GType new_type =
			g_enum_register_static(g_intern_static_string("VipsForeignPdfPageBox"), values);
		g_once_init_leave(&gtype_id, new_type);
	}
...
GType
vips_foreign_heif_encoder_get_type(void)
{
	static gsize gtype_id = 0;

	if (g_once_init_enter(&gtype_id)) {
		static const GEnumValue values[] = {
			{ VIPS_FOREIGN_HEIF_ENCODER_AUTO, "VIPS_FOREIGN_HEIF_ENCODER_AUTO", "auto" },
			{ VIPS_FOREIGN_HEIF_ENCODER_AOM, "VIPS_FOREIGN_HEIF_ENCODER_AOM", "aom" },
			{ VIPS_FOREIGN_HEIF_ENCODER_RAV1E, "VIPS_FOREIGN_HEIF_ENCODER_RAV1E", "rav1e" },
			{ VIPS_FOREIGN_HEIF_ENCODER_SVT, "VIPS_FOREIGN_HEIF_ENCODER_SVT", "svt" },
			{ VIPS_FOREIGN_HEIF_ENCODER_X265, "VIPS_FOREIGN_HEIF_ENCODER_X265", "x265" },
			{ 0, NULL, NULL }
		};

		GType new_type =
			g_enum_register_static(g_intern_static_string("VipsForeignHeifEncoder"), values);
		g_once_init_leave(&gtype_id, new_type);
	}
...
vips_interpretation_get_type(void)
{
	...
	if (g_once_init_enter(&gtype_id)) {
		static const GEnumValue values[] = {
			...
			{ VIPS_INTERPRETATION_OKLAB, "VIPS_INTERPRETATION_OKLAB", "oklab" },
			{ VIPS_INTERPRETATION_OKLCH, "VIPS_INTERPRETATION_OKLCH", "oklch" },
			{ 0, NULL, NULL }
		};
...
vips_argument_flags_get_type(void)
{
	...
	if (g_once_init_enter(&gtype_id)) {
		static const GFlagsValue values[] = {
			...
			{ VIPS_ARGUMENT_NON_HASHABLE, "VIPS_ARGUMENT_NON_HASHABLE", "non-hashable" },
			{ 0, NULL, NULL }
		};
...
vips_operation_flags_get_type(void)
{
	...
	if (g_once_init_enter(&gtype_id)) {
		static const GFlagsValue values[] = {
			...
			{ VIPS_OPERATION_REVALIDATE, "VIPS_OPERATION_REVALIDATE", "revalidate" },
			{ 0, NULL, NULL }
		};
...
vips_kernel_get_type(void)
{
	...
	if (g_once_init_enter(&gtype_id)) {
		static const GEnumValue values[] = {
			...
			{ VIPS_KERNEL_MKS2013, "VIPS_KERNEL_MKS2013", "mks2013" },
			{ VIPS_KERNEL_MKS2021, "VIPS_KERNEL_MKS2021", "mks2021" },
			{ 0, NULL, NULL }
		};
